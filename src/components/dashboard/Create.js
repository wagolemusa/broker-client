...
const [postdata, setPostdata] = useState([]);
    ...
    return (
        <section className="sider flex pt-20">
            ...
            <button type="button"
                class="text-white bg-teal-400 float-right hover:bg-teal-500 duration-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen2">
               Create Shell
            </button>
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              postdata?.map((printPost) => { 
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={printPost._id}>
